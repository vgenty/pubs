...
export PUB_PSQL_READER_USER=$PROD_PUB_PSQL_READER_USER
export PUB_PSQL_READER_ROLE="uboone_admin"
export PUB_PSQL_READER_DB=microboone_dev
export PUB_PSQL_READER_PASS=$PROD_PUB_PSQL_READER_PASS
...
export PUB_PSQL_WRITER_USER=$PROD_PUB_PSQL_WRITER_USER
export PUB_PSQL_WRITER_ROLE="uboone_admin"
export PUB_PSQL_WRITER_DB=microboone_dev
export PUB_PSQL_WRITER_PASS=$PROD_PUB_PSQL_WRITER_PASS
...
export PUB_PSQL_ADMIN_USER=$PROD_PUB_PSQL_ADMIN_USER
export PUB_PSQL_ADMIN_ROLE="uboone_admin"
export PUB_PSQL_ADMIN_DB=microboone_dev
export PUB_PSQL_ADMIN_PASS=$PROD_PUB_PSQL_ADMIN_PASS
